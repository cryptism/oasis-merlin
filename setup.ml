...
(* OASIS_START *)
(* DO NOT EDIT (digest: 144359dc1b600ba4901774b3c732d871) *)
(*
...
let setup_t =
  {
                 ...
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage
                             ("oasis", Some (OASISVersion.VGreater "0.4.7"))
                        ];
                   ...
                   {
                      lib_modules = ["OASISMerlin"];
                      lib_pack = false;
                      lib_internal_modules = ["OASISMerlinGettext"];
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "oasis-merlin";
                           FindlibPackage ("oasis.builtin-plugins", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\2355\015t\018\004z\167\n\218\140\142h\251\011z";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
